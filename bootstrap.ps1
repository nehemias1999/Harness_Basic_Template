...
# Same candidate order and the same >= 3.9 gate as the verifier. They used to
# differ: the wrappers probed only `print('PYOK')`, so the most destructive
# scripts in the harness could run under an interpreter the verifier rejects.
$Py = $null
